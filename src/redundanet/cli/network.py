...
TINC_PORT={tinc_port}
SHARES_NEEDED={tahoe.get("shares_needed", 3)}
SHARES_HAPPY={tahoe.get("shares_happy", 7)}
SHARES_TOTAL={tahoe.get("shares_total", 10)}
RESERVED_SPACE={tahoe.get("reserved_space", "1G")}
"""
